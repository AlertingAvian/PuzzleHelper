...
/* 
 * This is all a copy of TheoCrystal
 * Just to figure out how it works
 * will be removed when figuring has been done
 */

namespace Celeste.Mod.TestCrystal
{
    [Tracked]
    ...
    public TestCrystal(EntityData e, Vector2 offset)
        ...
        private void ImpactParticles(Vector2 dir) // NO PARTICLES
        {
            ...
            //Level.Particles.Emit(P_Impact, 12, position, positionRange, direction);  // Particles cause game to crash with this test crystal havent tried to figure out why yet though
